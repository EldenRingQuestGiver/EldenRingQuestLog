...
static std::array<shop, 22> mod_shops = {
    shop{.id = erquestlog::shops::weapons},
    shop{.id = erquestlog::shops::armor},
    shop{.id = erquestlog::shops::spells},
    shop{.id = erquestlog::shops::talismans},
    shop{.id = erquestlog::shops::ammunition},
    shop{.id = erquestlog::shops::ashes_of_war},
    shop{.id = erquestlog::shops::spirit_summons},
    shop{.id = erquestlog::shops::consumables},
    shop{.id = erquestlog::shops::materials},
    shop{.id = erquestlog::shops::miscellaneous_items},
    shop{.id = erquestlog::shops::cut_goods},
    shop{.id = erquestlog::shops::cut_armor},
    shop{.id = erquestlog::shops::dlc_weapons},
    shop{.id = erquestlog::shops::dlc_armor},
    shop{.id = erquestlog::shops::dlc_spells},
    shop{.id = erquestlog::shops::dlc_talismans},
    shop{.id = erquestlog::shops::dlc_ammunition},
    shop{.id = erquestlog::shops::dlc_ashes_of_war},
    shop{.id = erquestlog::shops::dlc_spirit_summons},
    shop{.id = erquestlog::shops::dlc_consumables},
    shop{.id = erquestlog::shops::dlc_materials},
    shop{.id = erquestlog::shops::dlc_miscellaneous_items},
};
...
static shop *get_mod_shop(int shop_lineup_id)
{
    ...
    {
        if (shop_lineup_id >= shop.id && shop_lineup_id < shop.id + erquestlog::shop_capacity)
        {
            return &shop;
        }
    }
...
static void open_regular_shop_detour(void *unk, long long begin_id, long long end_id)
{
    ...
    if (erquestlog::config::auto_upgrade_weapons && shop &&
        (shop->id == erquestlog::shops::weapons || shop->id == erquestlog::shops::dlc_weapons))
    {
...
void erquestlog::setup_shops()
{
         ...
         from::params::get_param<from::paramdef::EQUIP_PARAM_WEAPON_ST>(L"EquipParamWeapon"))
    {
        ...
        bool is_dlc = false;
        auto weapon_name = erquestlog::get_message(from::msgbnd::weapon_name, id);
        if (weapon_name.empty())
        {
            is_dlc = true;
            weapon_name = erquestlog::get_message(from::msgbnd::dlc_weapon_name, id);
        }
         ...
         from::params::get_param<from::paramdef::EQUIP_PARAM_PROTECTOR_ST>(L"EquipParamProtector"))
    {
        ...
        bool is_dlc = false;
        auto protector_name = erquestlog::get_message(from::msgbnd::protector_name, id);
        if (protector_name.empty())
        {
            is_dlc = true;
            protector_name = erquestlog::get_message(from::msgbnd::dlc_protector_name, id);
        }
    ...
    {
        bool is_dlc = false;
        auto accessory_name = erquestlog::get_message(from::msgbnd::accessory_name, id);
        if (accessory_name.empty())
        {
            is_dlc = true;
            accessory_name = erquestlog::get_message(from::msgbnd::dlc_accessory_name, id);
        }
         ...
         from::params::get_param<from::paramdef::EQUIP_PARAM_GOODS_ST>(L"EquipParamGoods"))
    {
        ...
        bool is_dlc = false;
        auto goods_name = erquestlog::get_message(from::msgbnd::goods_name, id);
        if (goods_name.empty())
        {
            is_dlc = true;
            goods_name = erquestlog::get_message(from::msgbnd::dlc_goods_name, id);
        }
    ...
    {
        bool is_dlc = false;
        auto gem_name = erquestlog::get_message(from::msgbnd::gem_name, id);
        if (gem_name.empty())
        {
            is_dlc = true;
            gem_name = erquestlog::get_message(from::msgbnd::dlc_gem_name, id);
        }
